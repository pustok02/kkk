...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionSlider : MonoBehaviour
    {
		...
		public GameObject GUIturnoff3;        // Whether the bar should disappear instantly once it's been filled.
        ...
        private void OnEnable ()
        {
           ...
           // m_VRInput.OnUp += HandleUp;
			...
			m_InteractiveItem.OnOver += HandleDown;
			m_InteractiveItem.OnOut += HandleUp;
        }
